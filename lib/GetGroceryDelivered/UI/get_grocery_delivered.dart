...
import 'package:fz_courier/GetGroceryDelivered/UI/groceryconfirm_info.dart';
...
class GetGroceryDeliveredPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GetGroceryDeliveredBody();
  }
}

class GetGroceryDeliveredBody extends StatefulWidget {
  @override
  _GetGroceryDeliveredBodyState createState() =>
      _GetGroceryDeliveredBodyState();
}

class _GetGroceryDeliveredBodyState extends State<GetGroceryDeliveredBody> {
  int currentIndex = 0;
                    ...
                    Expanded(
                      child: PageView(
                        ...
                        children: [
                          ...
                          groceryItems(theme, locale),
                          GroceryConfirmInfoPage(),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget groceryItems(ThemeData theme, AppLocalizations locale) {
    return ClipRRect(
